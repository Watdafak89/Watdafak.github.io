...
if generate_clicked:
    ...
    try:
        ...
        1. topic: สรุปเฉพาะชื่อหน่วยการเรียนรู้และหัวข้อสำคัญแบบกระชับ ไม่เกิน 3 บรรทัด หากเนื้อหาต้นฉบับยาว ให้ตัดคำอธิบายและรายละเอียดที่ซ้ำออก ห้ามใส่ผลลัพธ์การเรียนรู้หรือประโยคเกริ่นนำ
